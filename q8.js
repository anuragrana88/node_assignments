...
//Use Promises to create our flow/import/export/connection documents
...
var createFTPConnection = function () {
    return new Promise(function (resolve, reject) {
        request({
                'url': 'https://api.integrator.io/v1/connections',
                'method': 'POST',
            ...
            function (errFTPCon, resFTPCon, bodyFTPCon) {
                ...
                resolve(bodyFTPCon['_id']);
            });
    });
};

var createFTPImport = function () {
    return new Promise(function (resolve, reject) {
        request({
